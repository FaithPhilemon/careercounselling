                    ...
                    <table class="table table-striped">
                      ...
                      <?php  foreach($admin as $a):?>
                        <tr>
                          ...
                          <td><a href="update/<?php echo $a->id;?>"><button type="button" class="btn btn-primary">Update</button></a></td>
                          <td><a href="delete/<?php echo $a->id;?>"><button type="button" class="btn btn-primary">Delete</button></a></td>
                        </tr>
                        <?php endforeach;?>
                      </tbody>
                    </table>
