        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-center">Update Courses</h4>
                  <div class="row">
                        <div class="col-md-8 offset-2">
                    <?php echo validation_errors('<div class ="alert alert-danger">','</div>');?>
                    <?php foreach($update as $u):?>
                    <form method="post" action="<?php echo base_url();?>admin/add_courses">
                          <div class="form-group">
                            <label>Degree*</label>
                            <input type="text" class="form-control" name="degree" required="required" value="<?=$u->degree;?>">
                          </div>
                          <div class="form-group">
                            <label>Key Requirement</label>
                            <input type="text" class="form-control" name="key_requirement" required="required" value="<?=$u->key_requirement;?>">
                          </div>
                          <div class="form-group">
                            <label>Other requirements*</label>
                            <input type="text" class="form-control" name="other_requirements" required="required" value="<?=$u->other_requirements;?>">
                          </div>
                          <div class="form-group">
