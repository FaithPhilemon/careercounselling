        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-center">Add Courses</h4>
                  <div class="row">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/add_courses">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="key_requirement" required="required">
                          </div>
                          <div class="form-group">
                            <label>Other requirements*</label>
                            <input type="text" class="form-control" name="other_requirements" required="required">
                          </div>
                          <div class="form-group">
