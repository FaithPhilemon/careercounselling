            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php endif;?>
                  <?php if($this->session->flashdata('course_delete')):?>
                    <div class="alert alert-success text-center">
                      <?=$this->session->flashdata('course_delete');?>
                    </div>
                  <?php endif;?>
                  <div class="row">
                        ...
                        <tbody>
                          <?php foreach($course as $courses):?>
                            <tr>
                              ...
                              <td><a href="update_course/<?php echo $courses->id;?>"><button type="button" class="btn btn-primary">Update</button></a></td>
                              <td><a href="delete_course/<?php echo $courses->id;?>"><button type="button" class="btn btn-primary">Delete</button></a></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                      </table>
